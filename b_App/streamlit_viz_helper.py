...
def render_spending_footprint_tab(me_processed_df, econ_index_df, funding_source, department_mapping_df, comparison_df_current, comparison_df_previous, current_year, prev_year, single_chart_ratio, suffix):
